...
begin
  ...
  // Listagem de Operações por Loja
  ...
  begin
    ...
    if rdbIncluirFiltro.Checked = True then
       rel_OperacoesLoja.lblFiltro.Caption := 'Cliente..: ' + wNome + ' |  Operação Inicial: ' + DateToStr(dtOperacaoInicial.Date) + ' | Operação Final : ' + DateToStr(dtOperacaoFinal.Date)
    else
